...
public class PostingConsole {
	...
	public void register() {
		...
		while (true) {
			...
			try {
				...
				postingDto.setUsid(postingService.register(currentBoard.getClubId(), postingDto));
	...
	public void findByBoardId() {
		...
		try {
			List<PostingDto> postings = postingService.findByBoardId(currentBoard.getClubId());
			int idx = 0;
