...
const TravelClub_1 = __importDefault(require("../entity/club/TravelClub"));
const ClubService_1 = __importDefault(require("../service/ClubService"));
class ClubWindow {
    constructor() {
        this._clubCoordinator = new ClubService_1.default();
    }
    register() {
        let newClub = null;
        while (true) {
