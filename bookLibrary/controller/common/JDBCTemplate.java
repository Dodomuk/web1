package mukroject_library.bookLibrary.controller.common;
...
public class JDBCTemplate {
	...
	/*
	 * //singleton 패턴 //클래스의 인스턴스가 하나만 생성되어야 할 때 사용하는 디자인 패턴 private static class
	 * LazyHolder{ private static final JDBCTemplate INSTANCE = new JDBCTemplate();
	 * }
	 * 
	 * //생성자를 private으로 만들어서 외부에서 JDBCTemplate의 생성을 차단 private JDBCTemplate() { //1.
	 * OracleDriver를 JVM에 등록 try { Class.forName("oracle.jdbc.driver.OracleDriver");
