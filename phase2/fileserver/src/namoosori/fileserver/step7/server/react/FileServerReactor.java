...
public class FileServerReactor extends Thread {
	...
	private FileServerReactor(EventQueue eventQueue) {
		// 
		this.servicePort = 3333; 
		this.eventQueue = eventQueue; 
	}
	
	public static FileServerReactor newInstance(EventQueue eventQueue) {
		// 
		return new FileServerReactor(eventQueue); 
	}
